package ru.stroy1click.web.subcategory.client.impl;
...
@Slf4j
@Service
@CircuitBreaker(name = "subcategoryClient")
public class SubcategoryClientImpl implements SubcategoryClient {
    ...
    @Override
    public void update(Integer id, SubcategoryDto dto, String jwt) {
